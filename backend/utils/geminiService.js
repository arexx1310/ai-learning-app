...
export const chatWithContext = async (question, chunks) => {
    ...
    const prompt = `based on the following context from a document, Analyse the context and the user's question
...
export const explainConcept = async (concept, context) => {
    ...
    Provide clear, educational explanation that's easy to understand.
